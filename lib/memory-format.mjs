...
export function getLinkedIds(meta) {
  ...
  return meta.links.map(l => ({ id: l.id, relation: l.relation, strength: l.strength ?? 0.5 }));
}

/**
 * Add a link to a memory's meta (deduplicates by id).
 */
export function addLink(meta, targetId, relation, strength = 0.5) {
  ...
  if (existing) {
    ...
    meta.links.push({ id: targetId, relation, strength });
  }
}
